...
public class ejej6 {
    ...
    public static void main(String[] args) {
        ...
        9 donde la suma de sus filas, sus columnas y sus diagonales son idénticas. Crear
        un programa que permita introducir un cuadrado por teclado y determine si este cuadrado
